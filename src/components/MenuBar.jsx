    ...
    <Menubar.Root className="menubar-root flex p-1 overflow-hidden bg-[#1f1f1f] rounded-full">
      <div className="flex overflow-hidden rounded-full">
        <Menubar.Menu className="overflow-hidden rounded-full">
          <Menubar.Trigger className="py-1 fill-[#494949] hover:fill-[#757575] text-[#494949] hover:text-[#757575] hover:bg-[#2d2d2d] rounded-none px-3 outline-none select-none font-medium leading-none text-violet11 text-[13px] flex items-center justify-between gap-[2px] data-[highlighted]:bg-violet4 data-[state=open]:bg-violet4">
            <CaptionIcon />
            Captions
          </Menubar.Trigger>
          <Menubar.Portal>
