    ...
    >
      ...
      >
        <div
          data-open={open}
          id="search-icon"
          className="flex fill-[#a3a3a3] items-center w-24 h-24 absolute my-auto top-0 left-[10px] bottom-0 "
        >
        ...
        <input
          ...
          className="data-[open=false]:cursor-pointer search-input pl-11 mx-auto pointer-events-auto w-full h-full text-[#A3A3A3] bg-[#252525] inline-flex appearance-none items-center justify-center rounded-[4px] px-[10px] text-[15px] leading-none selection:color-red-500 selection:bg-blackA9"
          required
          data-open={open}
